  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", fontFamily: "Georgia, serif" }}>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "32px" }}>
          {team.map((t, i) => (
            <div key={i} style={{
              ...
              <div>
                <div style={{ width: "80px", height: "80px", background: t.highlight ? "#0a2463" : "#e8edf5", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center", color: t.highlight ? "white" : "#555", fontWeight: "800", fontSize: "28px", marginBottom: "20px" }}>
                  {t.name.split(" ")[1][0]}
                </div>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
                  {t.specialities.map((s, j) => (
                    <div key={j} style={{ background: "white", border: "1.5px solid #e0e7ff", borderRadius: "8px", padding: "8px 16px", fontSize: "13px", color: "#0a2463", fontWeight: "500" }}>{s}</div>
                  ))}
                </div>
              </div>
            </div>
      ...
      <div style={{ background: "#0a2463", padding: "80px 5%", textAlign: "center" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "16px", marginBottom: "32px" }}>Get expert orthopaedic care from our experienced team.</p>
